            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.store.getToken()];
                    case 1:
                        token = _a.sent();
                        if (token) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        options = (_a.headers = _b.sent(),
                            _a);
                        return [2 /*return*/, this.http.get(path, options).toPromise()];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        options = (_a.headers = _b.sent(),
                            _a);
                        return [2 /*return*/, this.http.post(path, data, options).toPromise()];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        options = (_a.headers = _b.sent(),
                            _a);
                        return [2 /*return*/, this.http.put(path, data, options).toPromise()];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        options = (_a.headers = _b.sent(),
                            _a);
                        return [2 /*return*/, this.http.delete(path, options).toPromise()];
                }
            });
        });
    };
