...
var CategoriaFormPageModule = /** @class */ (function () {
    function CategoriaFormPageModule() {
    }
    CategoriaFormPageModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
                FormsModule,
    ...
    return CategoriaFormPageModule;
}());
export { CategoriaFormPageModule };
